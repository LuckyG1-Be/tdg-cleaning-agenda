      ...
      <div className="w-full max-w-sm bg-white rounded-2xl border border-zinc-200 shadow-sm p-6">
        ...
        <form onSubmit={submit} className="space-y-3">
          <div>
            ...
            <input className="mt-1 w-full rounded-xl border border-zinc-200 px-3 py-2 outline-none focus:ring-2 focus:ring-zinc-900/10"
              value={username} onChange={(e)=>setUsername(e.target.value)} autoComplete="username" />
          </div>
          <div>
            <label className="text-sm font-medium">Wachtwoord</label>
            <input type="password" className="mt-1 w-full rounded-xl border border-zinc-200 px-3 py-2 outline-none focus:ring-2 focus:ring-zinc-900/10"
